    ...
    <Box padding={0} margin={0} boxSizing="border-box">
      ...
      <Box display="flex" maxWidth="1100px" margin="0 auto" pt={5} gap={3}>
        ...
        <Box flex="1 1 auto">
          ...
          <Typography pt={3}>
            ENI hub is the Service Hub Enterprise Integration T‧AR‧D‧I‧ S is an
            internal product of ENI hub. The name stands for "Telekom
            ...
            Iris-Broker is the Identity-Provider component of T‧AR‧D‧I‧S, which
            is currently based on Keycloak Stargate is the API -Gateway
            component of T‧AR‧D‧I‧S, which is currently based on Kong system-
            cluster is a Kubernetes cluster managed by the ENI hub, which is an
            important part of T‧AR‧D‧I‧S and is currently available on AWS and
            CaaS
          </Typography>
